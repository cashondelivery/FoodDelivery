...
if(isset($_POST['signup']))
{
	...
	$a=date('Y-m-d');
	 $msg=mysqli_query($link,"insert into staff(fname,lname,email,password,contactno) values('$fname','$lname','$email','$password','$contact')");
...
$ret= mysqli_query($link,"SELECT * FROM staff WHERE email='$useremail' and password='$password'");
$num=mysqli_fetch_array($ret);

if($num>0)
{
$extra="staff/add_property.php";
...
if(isset($_POST['send']))
{
$row1=mysqli_query($link,"SELECT email,password from staff where email='".$_POST['email']."'");
