...
<div class="container">
	...
	<table class="table table-striped table-bordered">
		...
		<tbody>
			<?php 
				$sql="select * from purchase order by purchaseid desc limit 1";
				...
				while($row=$query->fetch_assoc()){
					...
					<tr>
						...
						<td width="200px"> <a href="#details<?php echo $row['purchaseid']; ?>" data-toggle="modal" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-search"></span> View Sales Details</a>
							...
							<a href="user-map.php ?>" data-toggle="modal" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-search"></span> Location</a>
							<?php include('indexdatabase.php'); ?>
